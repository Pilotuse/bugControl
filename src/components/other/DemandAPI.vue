<template>
  <div class="content">
    <h3 class="title">API文档</h3>
    <div class="button-list">
      <div class="add" v-if="buttonPermission">
        <el-button type="success" class="add-one" @click="dialogTableControl"
          >新增用户</el-button
        >
        <el-button type="success" class="add-manny" @click="batchTableControl"
          >批量新增</el-button
        >
      </div>
    </div>
    ...
    <div class="options">
      ...
      <div class="search-area">
        <span>搜索：</span>
        <el-input
          v-model="search.desciber"
          placeholder="请输入用户名"
        ></el-input>
      </div>
    </div>

    <demandTabs :demandTabs="demandTabs"></demandTabs>
...
export default {
  ...
  created() {
    ...
    this.buttonPermission =
      JSON.parse(localStorage.getItem("users")).author == "admin"
        ? true
        : false;
  },
};
